package org.atria.operations.dg.transforms

import com.spotify.scio.bigquery.TableRow
import org.atria.operations.dg.models.MetricTypes.{RRStringKV, SPointStat}
...
object SPointStatTransforms {
  ...
  def newPointStat(sksn:RRStringKV, ts:Instant, ts_end:Instant, value:Double):SPointStat = {
    ...
    val first = value
    val last = value
    SPointStat(sksn.source_key,sksn.stream_name, ts,ts_end, count,mean,stddev,sum,min,max,first,last)
  }
