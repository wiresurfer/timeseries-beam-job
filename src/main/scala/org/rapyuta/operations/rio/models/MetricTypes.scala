package org.rapyuta.operations.rio.models
...
object MetricTypes {
  ...
  case class RRStringKV(proj_id:String, dev_id:String)

  case class InfluxFields(key:String, value:Double)
  case class InfluxTags(key:String, value:String)
//  @scio.bigquery.BigQueryType.toTable
  case class RRMetricData(
                           timestamp:String, //
                           name:String, //
