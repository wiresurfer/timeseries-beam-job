...
import org.rapyuta.operations.rio.io.output
import org.joda.time.format.DateTimeFormat
import org.joda.time.{DateTimeZone, Duration}
import org.rapyuta.operations.rio.models.MetricTypes.SPointStat
import org.rapyuta.operations.rio.output.WriteBq
import org.rapyuta.operations.rio.utils.TableRefPartition
...
object MetricOutput {
  ...
  def BQOutputSink(outtag:String, instream:SCollection[SPointStat], bqprops:Properties = BQoutputProperties.DefaultBQProps("batch")) = {
